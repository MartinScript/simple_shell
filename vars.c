 ...
 */
int is_chain(uninfo_t *info, char *buf, size_t *p)
{
	size_t j = *p;
 ...
 * Return: Void
 */
void chain_check(uninfo_t *info, char *buf, size_t *p, size_t i, size_t len)
{
	size_t j = *p;
 ...
 */
int alias_replace(uninfo_t *info)
{
	int i;
	lists_t *node;
	char *p;
 ...
 * Return: 1 if replaced, 0 otherwise
 */
int vars_replace(uninfo_t *info)
{
	int i = 0;
	lists_t *node;
