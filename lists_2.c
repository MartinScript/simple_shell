...
/**
 * print_list - prints all elements of a lists_t linked list
 * @h: pointer to first node
 *
 * Return: size of list
 */
 ...
 */
lists_t *node_starts_with(lists_t *node, char *prefix, char c)
{
	char *p = NULL;
 ...
 */
ssize_t node_index(lists_t *head, lists_t *node)
{
	size_t i = 0;
